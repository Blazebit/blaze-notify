 ...
 * @since 1.0.0
 */
public class EntityDomainTypeAttributeImpl extends AbstractMetadataHolderImpl implements EntityDomainTypeAttribute {

    private final EntityDomainType owner;
    private final String name;
    private final DomainType type;

    public EntityDomainTypeAttributeImpl(Map<Class<?>, Object> metadata, EntityDomainType owner, String name, DomainType type) {
        super(metadata);
        this.owner = owner;
        this.name = name;
        this.type = type;
