...
public class SmtpNotificationMessage implements NotificationMessage {
    ...
    public SmtpNotificationMessage(String from, String fromDisplayName, String replyTo, String replyToDisplayName, String envelopeFrom, EmailSubject subject, EmailBody textBody, EmailBody htmlBody, Collection<Attachment> attachments) {
        this.from = from;
    ...
    public SmtpNotificationMessage(String from, EmailSubject subject, EmailBody textBody, EmailBody htmlBody) {
