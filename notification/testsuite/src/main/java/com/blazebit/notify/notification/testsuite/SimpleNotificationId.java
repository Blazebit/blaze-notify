...
import com.blazebit.notify.notification.memory.model.AbstractNotificationId;
...
public class SimpleNotificationId extends AbstractNotificationId<Long, Long> {
    ...
    public SimpleNotificationId(Long notificationJobInstanceId, Long recipientId) {
