...
public class NotificationRateLimitException extends NotificationException {
    ...
    public NotificationRateLimitException(Throwable cause) {
        super(cause);
    }

    public NotificationRateLimitException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
