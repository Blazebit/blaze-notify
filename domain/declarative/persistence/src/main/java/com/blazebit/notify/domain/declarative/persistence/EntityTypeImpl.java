...
class EntityTypeImpl implements com.blazebit.notify.domain.persistence.EntityType, MetadataDefinition<com.blazebit.notify.domain.persistence.EntityType> {
