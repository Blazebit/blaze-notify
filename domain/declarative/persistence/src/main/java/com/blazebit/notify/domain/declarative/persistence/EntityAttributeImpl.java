...
class EntityAttributeImpl implements com.blazebit.notify.domain.persistence.EntityAttribute, MetadataDefinition<com.blazebit.notify.domain.persistence.EntityAttribute> {
