 ...
 */
package com.blazebit.notify.template.api.exception;
...
public class TemplateProcessorException extends RuntimeException {
    ...
    public TemplateProcessorException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
